...
import IQAbout from "./components/IQ_Test/IQAbout";
...
import IQTest from "./components/IQ_Test/IQTest";
import IQResult from "./components/IQ_Test/IQResult";
            ...
            <BrowserRouter>
              ...
              <Routes>
                <Route path="/" element={<Layout />}>
                  ...
                  <Route path="about/iq" element={<IQAbout />} />
                  ...
                  <Route path="iq-result" element={<IQResult />} />
                  <Route path="iq-result/:resultId" element={<IQResult />} />
                  <Route
                    path="dashboard"
                    element={
                      <ProtectedRoute>
