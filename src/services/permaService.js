...
export const permaService = {
  getQuestions: async () => {
    try {
      const response = await apiConnector(
        "GET",
        API_ENDPOINTS.PERMA.GET_QUESTIONS
      );
      return response;
    } catch (error) {
      return {
  ...
  submitTest: async (answers) => {
    try {
      const response = await apiConnector(
        "POST",
        API_ENDPOINTS.PERMA.SUBMIT_TEST,
        { responses: answers }
      );
      return response;
    } catch (error) {
  ...
  submitTestGuest: async (answers, sessionId) => {
    try {
      const response = await apiConnector(
        "POST",
        API_ENDPOINTS.PERMA.SUBMIT_TEST_GUEST,
  ...
  claimResult: async (sessionId) => {
    try {
      const response = await apiConnector(
        "POST",
        API_ENDPOINTS.PERMA.CLAIM_RESULT,
        { sessionId }
      );
      return response;
    } catch (error) {
  ...
  getResult: async (resultId) => {
    try {
      const response = await apiConnector(
        "GET",
        `${API_ENDPOINTS.PERMA.GET_RESULT}/${resultId}`
      );
      return response;
    } catch (error) {
      return {
  ...
  getUserResults: async () => {
    try {
      const response = await apiConnector(
        "GET",
        API_ENDPOINTS.PERMA.GET_USER_RESULTS
      );
      return response;
    } catch (error) {
      return {
